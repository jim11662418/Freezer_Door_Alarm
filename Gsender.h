...
class Gsender {
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "amltMTE2NjI0MThAZ21haWwuY29t";   // jim11662418@gmail.com
        const char* EMAILBASE64_PASSWORD = "aFI2MzcmanRhRg==";            // hR637&jtaF
        const char* FROM = "jim11662418@gmail.com";
